<div class="table-attributes">
  ...
  <table class="car-details">
    ...
    <tr>
      <td><label><?php _e('Engine size (cc)', 'cars_attributes'); ?></label></td>
      <td><?php echo @$detail['i_engine_size']; ?></td>
    </tr>
    <?php } ?>
    <?php if( !empty($detail['i_num_airbags']) ) { ?>
    <tr>
      <td><label><?php _e('Num. Airbags', 'cars_attributes'); ?></label></td>
    ...
    <tr>
      ...
      <td><label><?php _e('Transmission', 'cars_attributes'); ?></label></td>
    ...
    <tr>
      <td><label><?php _e('Power', 'cars_attributes'); ?></label></td>
      <td><?php echo @$detail['i_power']; ?> <?php echo @$detail['e_power_unit']; ?></td>
    </tr>
    <?php } ?>
    <?php if( !empty($detail['i_gears']) ) { ?>
    <tr>
      <td><label><?php _e('Gears', 'cars_attributes'); ?></label></td>
