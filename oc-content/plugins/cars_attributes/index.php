<?php
/*
  Plugin Name: Car Attributes Plugin
  Plugin URI: https://osclasspoint.com/
  Description: Plugin extends a category of items to store cars attributes such as model, year, brand, color, accessories etc.
  Version: 3.3.0
  Author: MB Themes
  Author URI: https://osclasspoint.com
  Author Email: info@osclasspoint.com
  Short Name: cars_plugin
  Plugin update URI: cars_plugin
  Support URI: https://forums.osclasspoint.com/free-plugins/
  Product Key: 2W7JWqCbxXdMfrrPLWxv
*/
