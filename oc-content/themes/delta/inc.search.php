          ...
          <form action="<?php echo osc_base_url(true); ?>" method="GET" class="nocsrf" id="home-form" >
            ...
            <div class="col c1">
              ...
              <div id="query-picker" class="query-picker">
                ...
                <input type="text" name="sPattern" class="pattern" placeholder="<?php echo osc_esc_html(__('Ex.: telemóvel, carro, casa…', 'delta')); ?>" value="<?php echo Params::getParam('sPattern'); ?>" autocomplete="off"/>
            ...
            <div class="col c3">
              ...
              <div id="location-picker" class="loc-picker ctr-<?php echo (del_count_countries() == 1 ? 'one' : 'more'); ?>">
                <div class="mini-box">
                  ...
                  <input type="text" class="term location" placeholder="<?php echo osc_esc_html(__('Praia, Mindelo, Sal…', 'delta')); ?>" value="<?php echo del_get_term(Params::getParam('term'), Params::getParam('sCountry'), Params::getParam('sRegion'), Params::getParam('sCity')); ?>" autocomplete="off" data-alt-placeholder="<?php echo osc_esc_html(__('Type to filter results', 'delta')); ?>"/>
                  <svg class="svg-right" viewBox="0 0 32 32" color="#696766" width="12px" height="12px"><defs><path id="mbIconAngle" d="M12.147 25.2c-.462 0-.926-.185-1.285-.556L.57 14.024A2.05 2.05 0 010 12.586c0-.543.206-1.061.571-1.436L10.864.553a1.765 1.765 0 012.62.06c.71.795.683 2.057-.055 2.817l-8.9 9.16 8.902 9.183c.738.76.761 2.024.052 2.815a1.78 1.78 0 01-1.336.612"></path></defs><use fill="currentColor" transform="matrix(0 -1 -1 0 29 24)" xlink:href="#mbIconAngle" fill-rule="evenodd"></use></svg>
                </div>
