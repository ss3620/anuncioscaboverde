...
osc_enqueue_style('style', osc_current_web_theme_url('css/style.css?v=' . DELTA_THEME_VERSION . '-acv4'));
osc_enqueue_style('responsive', osc_current_web_theme_url('css/responsive.css?v=' . DELTA_THEME_VERSION . '-acv4'));
?>
...
if(del_is_rtl()) {
  osc_enqueue_style('rtl', osc_current_web_theme_url('css/rtl.css') . '?v=' . DELTA_THEME_VERSION . '-acv4');
}
...
osc_register_script('global', osc_current_web_theme_js_url('global.js?v=' . DELTA_THEME_VERSION . '-acv4'), array('jquery'));
