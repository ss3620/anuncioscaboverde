  ...
  <div class="simple-wrap">
    ...
    <div class="data">
      ...
      <div class="details isGrid">
        ...
        <?php if($transaction_condition == '') { ?>
          <?php
            $category_location = array_filter(array_map('trim', array_filter(array(del_item_location(), osc_item_category()))));
      ...
      <div class="extra isList">
        <?php if(del_item_location(false, true) <> '') { ?>
          <span class="location"><i class="fas fa-map-marked-alt"></i> <span><?php echo __('Located:', 'delta'); ?></span> <strong><?php echo del_item_location(false, true); ?></strong></span>
        <?php } ?>
