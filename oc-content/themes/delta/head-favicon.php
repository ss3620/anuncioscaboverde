...
if(del_param('sample_favicons') == 1) {
  $dir = 'favicons/sample/';
} else {
  $dir = 'favicons/';
}
...
require_once ABS_PATH . 'oc-content/themes/delta/functions.php';

$path = osc_base_path() . 'oc-content/themes/delta/images/' . $dir;
$url = osc_base_url() . 'oc-content/themes/delta/images/' . $dir;
?>
