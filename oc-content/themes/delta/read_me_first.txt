------- How to install? ------
1. Upload theme (file: delta.zip) via oc-admin > appearance > themes and activate it
2. If 1) does not work, upload theme via ftp into folder oc-content/themes/ and then activate from oc-admin > appearance > themes
...
- go to oc-admin > Appearance > Theme settings > Category Icons
...
- go to oc-admin > Appearance > Theme settings > Advertisement
...
------- Favicons -----------------
- you can upload your favicons into folder: oc-content/themes/delta/images/favicons/
